...
public class SJFInput implements ActionListener {
    ...
    public SJFInput(ArrayList<org.os.Process> processes, int totalProcesses, ProcessInputListener listener, int currentProcessIndex) {
        ...
        priorityNumber.setBounds(150, 200, 200, 30);
        color.setBounds(150, 250, 200, 30);

        nameLabel.setBounds(30, 50, 100, 30);
        arrivalTimeLabel.setBounds(30, 100, 100, 30);
        burstTimeLabel.setBounds(30, 150, 100, 30);
        priorityNumberLabel.setBounds(30, 200, 100, 30);
        colorLabel.setBounds(30, 250, 100, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bot) {
            ...
            int Priority = Integer.parseInt(priorityNumber.getText());

            processes.add(new org.os.Process(Name,Color, ArrivalTime, BurstTime, Priority));
            frame.dispose();
