...
public class PriorityInput implements ActionListener {
    ...
    public PriorityInput(ArrayList<Process> processes, int totalProcesses, ProcessInputListener listener, int currentProcessIndex) {
